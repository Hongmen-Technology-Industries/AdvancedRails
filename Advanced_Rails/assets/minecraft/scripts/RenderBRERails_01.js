...
function init(par1, par2)
{
	...
	Ballasts = renderer.registerParts(new Parts("Ba1", "Ba2", "Ba13", "Ba4", "Ba5", "Ba6", "Ba7", "Ba8", "Ba9", "Ba10", "Ba11", "Ba12", "Ba13", "Ba14"));
...
function shouldRenderObject(tileEntity, objName, len, pos)
{
	...
	if(renderer.isSwitchRail(tileEntity))
	{
		if(objName === BallastTag || Pcs.containsName(objName))
		{
			return true;
		}
		return false;
	...
	{
		if(objName === BallastTag || Pcs.containsName(objName) || fixtureL.containsName(objName) || fixtureR.containsName(objName) || leftParts.containsName(objName) || rightParts.containsName(objName))
		{
			return true;
		}
		return false;
